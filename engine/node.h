...
/**
 * @brief Rappresenta un nodo nel grafo della scena, gestisce trasformazioni e
 * gerarchia.
 */
...
public:
  /**
   * @class Node
   * @brief Rappresenta un nodo nel grafo della scena, gestendo le
   * trasformazioni locali e la gerarchia padre-figlio.
   */
  ...
  /**
   * @brief Calcola la matrice di trasformazione globale moltiplicando la
   * matrice locale con quelle dei nodi genitori.
   * @return Matrice che rappresenta la trasformazione del nodo nello spazio
   * mondo (World Space).
   */
  ...
  /**
   * @brief Rimuove un nodo figlio specifico dalla lista dei figli e ne restituisce l'ownership.
   * @param child Puntatore al nodo da rimuovere.
   * @return Il nodo rimosso.
   */
...
private:
  /** @brief Matrice che definisce le trasformazioni geometriche locali rispetto
   * al padre. */
